        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EncryptedPhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ConsultationFeePerHour = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    AvailabilitySchedule = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    AppointmentLimitPerDay = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ratings_Users_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
